...
package com.kamoland.gvr_treasurehunt2;
...
import com.kamoland.util.DaydreamController;
...
public class TreasureHuntActivity extends GvrActivity implements GvrView.StereoRenderer {
  ...
  //#### DDコントローラー追加
  private DaydreamController ddController;
  private final float[] contrYawPitchRoll = new float[3];
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    //#### DDコントローラー追加．初期化とイベント登録
    ddController = new DaydreamController(this, new DaydreamController.EventListener() {
      @Override
      ...
      @Override
      public void onOrientationUpdate(Orientation orientation) {
        orientation.toYawPitchRollRadians(contrYawPitchRoll);
      }
    });
  }
  ...
  protected void onDestroy() {
    ...
    //#### DDコントローラー追加．ライフサイクルを通知しなければならない
    ddController.onDestroy();
  }
  ...
  public void initializeGvrView() {
    ...
    //#### DDコントローラー追加．enableCardboardTriggerEmulation()を使ってはいけないので無効化
//    gvrView.enableCardboardTriggerEmulation();
  ...
  public void drawCube() {
    ...
    //#### DDコントローラー追加．コントローラーの方位によってキューブを移動する
    float[] mat1 = new float[16];
    float[] mat2 = new float[16];
    Matrix.setIdentityM(mat1, 0);
    Matrix.translateM(mat1, 0, -10 * contrYawPitchRoll[0] / 1.57f,5 * contrYawPitchRoll[1] / 1.57f,0);
    Matrix.multiplyMM(mat2, 0, modelViewProjection, 0, mat1, 0);
    GLES20.glUniformMatrix4fv(cubeModelViewProjectionParam, 1, false, mat2, 0);
